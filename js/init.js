    ...
    plugins: {
      layers: {
       ...
       sidePanelToggle: {
         ...
         height: '4em',
         width: '5em',
         html: '<div class="clear-menu-btn"div data-action="toggleLayer" data-args="sidePanel" class="toggle"><input type="checkbox"><span class="top"></span><span class="middle"></span><span class="bottom"></span></div>'
        }
      }
    }
  });
$('#sidePanelToggle').click(function(){$('#nav-icon1').toggleClass('open'); }); 
  $(function() {
